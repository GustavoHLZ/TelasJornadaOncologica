...
void main() {
  runApp(MaterialApp(home: Frame8Cirurgias()));
}



class Frame8Cirurgias extends StatelessWidget {
  const Frame8Cirurgias({super.key});
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 12),
                textoWidget(texto: "Identificação da Cirurgia"),
                SizedBox(height: 12),
